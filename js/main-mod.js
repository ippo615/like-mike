	...
	$('#welcome-image').lazylinepainter( {
		...
		"onComplete": function(){
			setTimeout( function(){
				$('#welcome-text').fadeIn();
				setTimeout( function(){
					$('#welcome-text-1').fadeIn();
				}, 1000);
				setTimeout( function(){
					$('#welcome-text-2').fadeIn();
				}, 2000);
				setTimeout( function(){
					$('#welcome-text-3').fadeIn();
				}, 4000);
				setTimeout( function(){
					$('#welcome-text-4').fadeIn();
				}, 4500);
				setTimeout( function(){
					$('#welcome-text-5').fadeIn();
				}, 15000);
			}, 700 );
		}
...
function startGame(){
	...
	setTimeout(function(){
		dweetio.dweet_for("si-hacks-2015-05-16-blah-start", {thing:url}, function(err, dweet){
